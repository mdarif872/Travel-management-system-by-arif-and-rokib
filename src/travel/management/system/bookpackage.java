...
public class bookpackage extends JFrame implements ActionListener{
    ...
    bookpackage(String username){
       ...
       add(l16);
        ...
        JLabel l5=new JLabel("Personal ID(PID)");
        l5.setBounds(40,190,120,30);
        ...
        JLabel l6=new JLabel("PID Number");
        ...
        try{
          ...
          while(rs.next()){
              ...
              l12.setText(rs.getString("p_id"));
              l13.setText(rs.getString("pid_number"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
            ...
            if(p.equals("Gold Package")){
                cost+=50000;
            }else if(p.equals("Silver Packsge")){
                cost+=30000;
