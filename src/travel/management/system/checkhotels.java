...
public class checkhotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text=new String[]{"Long beach hotel,cox's bazar","Radisson Blu,Chittagong","InterContinental Hotel,Dhaka","Rose view hotel,Sylhet","Pan Pacific Sonargaon Hotel,Dhaka","le meridien,Dhaka","The Peninsula,Chittagong","Sayeman Beach Resort,Cox's Bazar","Nazimgarh Garden Resort,Sylhet","Sarah Resort,Gazipur"};
        try{
       for(int i=0;i<=9;i++){
