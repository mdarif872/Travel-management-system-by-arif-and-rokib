...
public class deleteuser extends JFrame implements ActionListener{
    ...
    deleteuser(String user){
        ...
        JLabel heading=new JLabel("DELETE USER DATA");
        ...
        try{
            ...
            while(rs.next()){
                ...
                l12.setText(rs.getString("fullname"));
       ...
       ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("Travel/management/system/icons/deleteuser.png"));
