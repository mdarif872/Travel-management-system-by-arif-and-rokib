...
public class updateuser extends JFrame implements ActionListener{
    ...
    updateuser(String username){
        ...
        JLabel l11=new JLabel("UPDATE USER DETAILS");
        ...
        JLabel l3=new JLabel("PID Number :");
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("Travel/management/system/icons/updateuser.png"));
        ...
        try{
            ...
            while(rs.next()){
                ...
                t2.setText(rs.getString("pid_number"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String q = "update customer set p_id = '"+p_id+"', pid_number = '"+pid_number+"', fullname = '"+fullname+"', gender = '"+radio+"', country = '"+country+"', address = '"+address+"', phone = '"+phone+"', email = '"+email+"' where username = '"+username+"'";
        try{
         connect c=new connect();
         c.s.executeUpdate(q);
